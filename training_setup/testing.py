...
def inference(args):
    ...
    prediction_sheet['labels'] = all_test_labels
    if args.modal_type == 'mm' and args.double_ensemble:
        validation_sheet.to_excel(args.results_dir + args.modal_type + '_inference_performances_double_ensemble.xlsx', index=False)
        prediction_sheet.to_excel(args.results_dir + args.modal_type + '_inference_test_predictions_double_ensemble.xlsx', index=False)
    elif args.early_ensemble:
        validation_sheet.to_excel(args.results_dir + args.modal_type + '_inference_test_performances_early_ensemble.xlsx', index = False)
        prediction_sheet.to_excel(args.results_dir + args.modal_type + '_inference_test_predictions_early_ensemble.xlsx', index=False)
    elif args.ensemble:
        validation_sheet.to_excel(args.results_dir + args.modal_type + '_inference_test_performances_ensemble.xlsx', index = False)
        prediction_sheet.to_excel(args.results_dir + args.modal_type + '_inference_test_predictions_ensemble.xlsx', index=False)
    else:
        validation_sheet.to_excel(args.results_dir + args.modal_type + '_inference_test_performances_no_ensemble.xlsx'.format(fold), index=False)
        prediction_sheet.to_excel(args.results_dir + args.modal_type + '_inference_test_predictions_no_ensemble.xlsx', index=False)
    print("Complete.")    
