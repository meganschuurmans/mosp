...
class EfficientNet(nn.Module):
    def __init__(
        ...
        current_image_size = _calculate_output_image_size(image_size, stride)
...
class EfficientNetBN(EfficientNet):
    def __init__(
        ...
        weight_coeff, depth_coeff, _, dropout_rate, dropconnect_rate = efficientnet_params[model_name]
